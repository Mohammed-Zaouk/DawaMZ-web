...
const translations = {
  ar: {
    ...
    metaTitle: "سياسة الخصوصية | DawaMZ",
    metaDesc:
      "سياسة خصوصية DawaMZ — كيف نتعامل مع بياناتك عند استخدام منصة الصيدليات",
    sections: [
      {
  ...
  fr: {
    ...
    sections: [
      ...
      },
      {
        ...
        content:
          "Toutes les données stockées localement sur votre appareil sont protégées par votre navigateur.",
      },
      {
  ...
  en: {
    ...
    sections: [
      ...
      },
      {
        ...
        content:
          "All data stored locally on your device is protected by your browser.",
      },
      {
