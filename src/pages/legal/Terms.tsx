...
const translations = {
  ar: {
    ...
    metaTitle: "شروط الاستخدام | DawaMZ",
    metaDesc: "شروط وأحكام استخدام منصة DawaMZ للعثور على الصيدليات في المغرب",
    sections: [
      {
        title: "1. قبول الشروط",
        content:
          "باستخدام الموقع، فإنك توافق على هذه الشروط والأحكام. إذا كنت لا توافق، يرجى عدم استخدام الموقع.",
      },
      {
      ...
      },
      {
        ...
        content:
          "جميع حقوق الموقع، بما في ذلك التصميم والشعار والمحتوى، محفوظة لـ DawaMZ.",
      },
      {
        title: "6. الموقع مجاني",
        content:
          "الموقع مجاني تماماً بدون:\n• إعلانات\n• رسوم اشتراك\n• أي تكاليف",
      },
      {
  ...
  fr: {
    ...
    intro:
      "En utilisant le site DawaMZ, vous acceptez de respecter ces conditions.",
    metaTitle: "Conditions d'utilisation | DawaMZ",
    metaDesc:
      "Conditions générales d'utilisation de la plateforme DawaMZ au Maroc",
    sections: [
      {
        title: "1. Acceptation des conditions",
        content:
          "En utilisant le site, vous acceptez ces termes et conditions. Si vous n'êtes pas d'accord, veuillez ne pas utiliser le site.",
      },
      {
      ...
      },
      {
        ...
        content:
          "Tous les droits du site, y compris la conception, le logo et le contenu, sont réservés à DawaMZ.",
      },
      {
        title: "6. Le site est gratuit",
        content:
          "Le site est entièrement gratuit sans :\n• Publicités\n• Frais d'abonnement\n• Aucun coût",
      },
      {
      ...
      },
      {
        title: "9. Contact",
        content:
          "Pour toute question concernant ces conditions, vous pouvez nous contacter via la page de contact.",
      },
    ],
  },
  en: {
    ...
    metaTitle: "Terms of Service | DawaMZ",
    metaDesc:
      "Terms and conditions for using the DawaMZ pharmacy finder platform in Morocco",

    sections: [
      {
        title: "1. Acceptance of Terms",
        content:
          "By using the site, you accept these terms and conditions. If you do not agree, please do not use the site.",
      },
      {
      ...
      },
      {
        ...
        content:
          "All rights to the site, including design, logo, and content, are reserved by DawaMZ.",
      },
      {
        title: "6. The Site is Free",
        content:
          "The site is completely free with no:\n• Advertisements\n• Subscription fees\n• Any costs",
      },
      {
      ...
      },
      {
        title: "9. Contact",
        content:
          "For questions about these terms, you can contact us via the contact page.",
      },
    ],
  },
};
...
export default function Terms() {
  ...
  return (
    <div className={styles.page} dir={isRTL ? "rtl" : "ltr"}>
      ...
      <p
        className={`${styles.intro} ${isRTL ? styles.introRtl : styles.introLtr}`}
      >
        {text.intro}
      </p>
